...
# ✨ AI Funchat - 你的定制化 AI Agent 🚀

> **随时随地，便捷召唤 AI！支持 MCP、Skill 技能库与定时任务，将 AI 从简单的“聊天机器人”升级为能够自主执行复杂任务的“全能AI助手”。**

<p align="center">
  <a href="https://www.u-tools.cn/plugins/detail/AI%20Funchat/">
    <img src="https://img.shields.io/badge/uTools-Plugin-blue?style=flat-square&logo=utools" alt="uTools Plugin">
  </a>
  <img src="https://img.shields.io/badge/License-MIT-green?style=flat-square" alt="License">
  <a href="https://github.com/Komorebi-yaodong/Funchat">
    <img src="https://img.shields.io/github/stars/Komorebi-yaodong/Funchat?style=flat-square" alt="Stars">
  </a>
</p>

Funchat 是一款为 **uTools** 打造的深度定制化 AI 助手插件。它不仅仅是一个聚合 API 的聊天窗口，更是一个集成了 **定时任务调度**、**MCP 工具调用**、**Skill 流程编排**、**多模态交互** 以及 **多端数据同步** 的生产力平台。

无论是日常的划词翻译、变量命名，还是全自动化的每日新闻摘要、系统监控、智能爬虫，它都能成为你最得力的 24 小时智能员工。同时，Funchat 也可作为 AI 服务商的集成平台，或个人提示词的理想存储与管理工具。
...
让 Funchat 成为你的全天候数字员工，无需人工干预即可自动工作。
...
打破 AI 与物理世界的隔阂。通过引入 **[Model Context Protocol (MCP)](https://modelcontextprotocol.io/)**，Funchat 让 AI 拥有了“双手”：
...
* **子智能体模式 (Sub-Agent)**：对于复杂任务，Funchat 可以启动一个独立的 Agent 专注执行该技能，主对话流仅接收最终结果。
...
我们为不同模块提供了详尽的文档，帮助你挖掘 Funchat 的潜力：
...
如果你想参与 Funchat 的开发，或者想自己编译修改版，请参考以下指南。
...
1. **克隆项目**
   ...
   ```bash
   git clone https://github.com/Komorebi-yaodong/Funchat.git
   cd Funchat
   ```
2. **安装依赖并构建前端**
...
[![Star History Chart](https://api.star-history.com/svg?repos=Komorebi-yaodong/Funchat&type=Timeline)](https://star-history.com/#Komorebi-yaodong/Funchat&Timeline)

---

## 🤝 社区与支持

Funchat 是一个持续进化的开源项目，欢迎加入社区交流心得、分享 Skill 或反馈 Bug。

* **GitHub Issues**: [提交反馈与建议](https://github.com/Komorebi-yaodong/Funchat/issues)
* **Gitee Issues**: [提交反馈与建议](https://gitee.com/Komorebi-yaodong/Funchat/issues)
